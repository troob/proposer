...
def read_all_players_season_logs(player_names, read_x_seasons=1, player_espn_ids={}, season_year=2024, all_players_teams={}):
	...
	for player_name in player_names:
		...
		player_espn_id = player_espn_ids[player_name]
		players_season_logs = read_player_season_logs(player_name, player_espn_id, read_x_seasons, player_espn_ids, season_year, all_players_season_logs, current_year_str=cur_yr_str, player_teams=player_teams)
